...
export default function ReportsPanel() {
  ...
  const STATS = [
    { Icon:BarChart2,  label:t('rp_hba1c'),         value:'6.8%',  change:'↓ 0.4%',         good:true },
    { Icon:Droplets,   label:t('rp_avg_glucose'),    value:'131',   unit:'mg/dL', change:'↓ 5', good:true },
        ...
        <div className={s.reportList}>
          {REPORTS.map(r => (
            <div key={r.title} className={s.reportItem}>
              <div className={s.reportIcon} style={{background:r.color+'20',color:r.color}}><r.Icon size={18} /></div>
