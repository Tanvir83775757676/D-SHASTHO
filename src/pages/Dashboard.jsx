  ...
  return (
    <div className={s.layout}>
      <nav className={s.sidebar}>
        ...
        {[['🧪',t('dash_nav_lab')],['💊',t('dash_nav_meds')],['👨‍👩‍👧',t('dash_nav_family')],['📚',t('dash_nav_education')]].map(([icon,label]) => (
      ...
      <div className={s.main}>
        <div className={s.topbar}>
          ...
          <div className={s.topbarRight}>
            <div className={s.iconBtn} title={t('dash_notif')}>🔔<div className={s.notifDot}/></div>
            <div className={s.iconBtn} title={t('dash_settings')}>⚙️</div>
